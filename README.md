# FHIR IG 'Consent Management' for the TTP-FHIR Gateway
...
This IG 'Consent Management' focuses on operations, profiles and extensions relevant for the [Consent Management gICS](https://ths-greifswald.de/gics).
...
# Compiled IG Version
The IG is available from [GitHub Pages](https://mosaic-hgw.github.io/ttp-fhir-ig-gics/main/index.html).

# Package Download
The generated package (TGZ-format) is available for download from: [Link](https://mosaic-hgw.github.io/ttp-fhir-ig-gics/main/package.tgz)
