...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://ths-greifswald.de/fhir/StructureDefinition/gics/PolicyVersionFormat"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://ths-greifswald.de/fhir/StructureDefinition/gics/ModuleVersionFormat"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://ths-greifswald.de/fhir/StructureDefinition/gics/TemplateVersionFormat"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://ths-greifswald.de/fhir/StructureDefinition/gics/ConfigurationProperties"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://ths-greifswald.de/fhir/StructureDefinition/gics/ValidFromProperty"]
      }],
      "mustSupport" : true
    },
    {
