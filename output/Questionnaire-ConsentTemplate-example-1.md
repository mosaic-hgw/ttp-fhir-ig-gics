...
```json
{
  ...
  },
  {
    "extension" : [{
      "url" : "key",
      "valueString" : "miiAnswerCodeSystem"
    },
    {
      "url" : "value",
      "valueString" : "2.16.840.1.113883.3.1937.777.24.5.2"
    }],
  ...
  },
  {
    "extension" : [{
      "url" : "key",
      "valueString" : "mii_answer_oid_no"
    },
    {
      "url" : "value",
      "valueString" : "2.16.840.1.113883.3.1937.777.24.5.2.2"
    }],
    "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/ExternalProperty"
  },
  {
  ...
  },
  {
    "extension" : [{
      "url" : "key",
      "valueString" : "miiAnswerValueSet"
    },
    {
      "url" : "value",
      "valueString" : "https://www.medizininformatik-initiative.de/fhir/ValueSet/MiiConsentAnswerValueSet"
    }],
    "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/ExternalProperty"
  },
  {
    "extension" : [{
      "url" : "key",
      "valueString" : "miiAnswerValueSetId"
    },
    {
      "url" : "value",
      "valueString" : "2.16.840.1.113883.3.1937.777.24.11.30"
    }],
    "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/ExternalProperty"
  },
  {
    "extension" : [{
      "url" : "key",
      "valueString" : "mii_answer_oid_unknown"
    },
    {
      "url" : "value",
      "valueString" : "2.16.840.1.113883.3.1937.777.24.5.2.3"
    }],
    "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/ExternalProperty"
  },
  {
    "extension" : [{
      "url" : "key",
      "valueString" : "miiPolicyCodesystem"
    },
    {
      "url" : "value",
      "valueString" : "2.16.840.1.113883.3.1937.777.24.5.3"
    }],
    "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/ExternalProperty"
  },
  {
  ...
  },
  {
    "extension" : [{
      "url" : "key",
      "valueString" : "mii_answer_oid_yes"
    },
    {
      "url" : "value",
      "valueString" : "2.16.840.1.113883.3.1937.777.24.5.2.1"
    }],
    "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/ExternalProperty"
  },
  {
  ...
  "item" : [{
    ...
    "linkId" : "header",
    "text" : "Einwilligung in die Nutzung von Patientendaten, [falls zutreffend: Krankenkassendaten und Biomaterialien (Gewebe und Körperflüssigkeiten)] für medizinische Forschungszwecke",
    "_text" : {
      "extension" : [{
        "url" : "http://hl7.org/fhir/StructureDefinition/rendering-xhtml",
        "valueString" : "<h2 style=\"text-align: justify;\">Einwilligung in die Nutzung von Patientendaten, [<span style=\"background-color: rgb(240, 102, 102);\">falls zutreffend</span>: Krankenkassendaten und Biomaterialien (Gewebe und Körperflüssigkeiten)] für medizinische Forschungszwecke</h2>"
      }]
    },
    "type" : "display"
  },
  {
    "extension" : [{
      ...
      "valueReference" : {
        "reference" : "Questionnaire/3386fb6-d2046-42bc-b6b0-9ac181c0d490"
      }
    },
    {
      "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/Position",
  ...
  },
  {
    "extension" : [{
      "url" : "http://fhir.de/ConsentManagement/StructureDefinition/SubQuestionnaire",
      "valueReference" : {
        "reference" : "Questionnaire/b6d309e-f3f7e-48b2-b742-b15146aba355"
      }
    },
    {
      "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/Position",
  ...
  },
  {
    "extension" : [{
      "url" : "http://fhir.de/ConsentManagement/StructureDefinition/SubQuestionnaire",
      "valueReference" : {
        "reference" : "Questionnaire/6ab9bba-5cf5f-48ee-b78c-99fe979aaf9c"
      }
    },
    {
      "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/Position",
  ...
  },
  {
    "extension" : [{
      "url" : "http://fhir.de/ConsentManagement/StructureDefinition/SubQuestionnaire",
      "valueReference" : {
        "reference" : "Questionnaire/b5a3007-4cded-461c-8bd5-383b97b945b7"
      }
    },
    {
      "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/Position",
  ...
  },
  {
    "extension" : [{
      "url" : "http://fhir.de/ConsentManagement/StructureDefinition/SubQuestionnaire",
      "valueReference" : {
        "reference" : "Questionnaire/5b999a9-6958d-4692-97d1-2c135af7fa33"
      }
    },
    {
      "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/Position",
  ...
  },
  {
    ...
    "linkId" : "Rekontaktierung_Intro|1.6",
    "type" : "display"
  },
  {
    "extension" : [{
      "url" : "http://fhir.de/ConsentManagement/StructureDefinition/SubQuestionnaire",
      "valueReference" : {
        "reference" : "Questionnaire/0cc1f7e-7a970-4256-9249-7c4eaa51d0b3"
      }
    },
    {
      "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/Position",
  ...
  },
  {
    "extension" : [{
      "url" : "http://fhir.de/ConsentManagement/StructureDefinition/SubQuestionnaire",
      "valueReference" : {
        "reference" : "Questionnaire/118fcfb-3ea77-4ad2-aa19-aa3486ba1d4b"
      }
    },
    {
      "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/Position",
  ...
  },
  {
    "extension" : [{
      "url" : "http://fhir.de/ConsentManagement/StructureDefinition/SubQuestionnaire",
      "valueReference" : {
        "reference" : "Questionnaire/c568d6f-acd4e-473e-a44e-4ebda1e1e443"
      }
    },
    {
      "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/Position",
  ...
  },
  {
    "extension" : [{
      "url" : "http://fhir.de/ConsentManagement/StructureDefinition/SubQuestionnaire",
      "valueReference" : {
        "reference" : "Questionnaire/2dc6277-98a8f-4e91-9a61-888827e511f4"
      }
    },
    {
      "url" : "https://ths-greifswald.de/fhir/StructureDefinition/gics/Position",
